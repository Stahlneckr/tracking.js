...
This is a fork of the tracking.js library. I've added to the getUserMedia call so that it will always get a 1280x720 video and always select the rear facing camera (if available).
